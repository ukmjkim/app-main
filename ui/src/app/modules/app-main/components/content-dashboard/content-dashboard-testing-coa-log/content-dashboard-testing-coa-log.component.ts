...
@Component({
  selector: 'aid-content-dashboard-testing-coa-log',
  templateUrl: './content-dashboard-testing-coa-log.component.html',
  styleUrls: ['./content-dashboard-testing-coa-log.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ContentDashboardTestingCOALogComponent {
  @Input() id: string;
