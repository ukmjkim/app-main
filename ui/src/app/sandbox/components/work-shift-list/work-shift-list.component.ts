...
export class WorkShiftListComponent extends AppPageBaseComponent {

  ContentDataType = ContentDataType.WorkShift;
  ContentDataTypeDisplayName = ContentDataType.WorkShift.displayName;
